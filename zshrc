...
alias clam='ssh adean@192.168.1.104'
...
alias rn='sudo service network-manager restart && sudo restart network-manager'
alias less='less -R'
...
alias cwd="pwd | tr -d '\n' | xclip -selection clipboard"
alias inc="mkdir -p ~/incoming && cp -r /mnt/s/to-lxss/* ~/incoming"
