...
alias tux='ssh -X ajd336@tux.cs.drexel.edu'
alias ent='ssh adean@192.168.1.121'
alias clam='ssh adean@192.168.1.16'
alias night='ssh Austin@192.168.1.128'
alias o='xdg-open'
alias batt='upower -i /org/freedesktop/UPower/devices/battery_BAT0 | grep -E "state|to\ full|percentage|time" | cat'
alias fp='readlink -f'
alias t='tree -fi'
alias T='tree -afi'
alias ct='clear && tree -fi'
...
alias ue='apt update -y && apt upgrade -y && apt update -y && apt full-upgrade -y && apt autoremove -y' # UPDATE EVERYTHING
...
alias sp="ps -ef | grep -v 'grep' | grep -ie"
alias SP="ps -ef | grep -v 'grep' | grep -e"
...
alias cx="ls -lAh | egrep '^.........x'"
alias crw="ls -lAh | egrep '^.......rw.'"
